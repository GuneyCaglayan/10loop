    ...
    <nav class="navbar navbar-top-default navbar-expand-lg navbar-gradient nav-icon alt-font">
        <div class="container">
            <a class="logo link scroll" href="javascript:void(0)" title="Logo">
                <!--Logo Default-->
                <img alt="logo" class="logo-dark default" src="img/logo-white.png">
            </a>
                    ...
                    <div class="tp-caption   tp-resizeme"
                        ...
                        <div class="rs-looped rs-slideloop" data-easing="" data-speed="5" data-xe="0" data-xs="0"
                             data-ye="15" data-ys="-15"><img alt="" data-hh="['87px','87px','87px','87px']"
                                                             data-no-retina
                                                             data-ww="['44px','44px','44px','44px']" src="img/shape-6.png">
                        </div>
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                        ...
                        <div class="rs-looped rs-wave" data-angle="0" data-origin="50% 50%" data-radius="15px"
                             data-speed="12"><img alt="" data-hh="['67px','67px','67px','67px']"
                                                        data-no-retina
                                                        data-ww="['68px','68px','68px','68px']" src="img/shape-4.png"></div>
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                        ...
                        <div class="rs-looped rs-slideloop" data-easing="" data-speed="2" data-xe="15" data-xs="0"
                             data-ye="0" data-ys="0"><img alt="" data-hh="['14px','14px','14px','14px']"
                                                          data-no-retina
                                                          data-ww="['50px','50px','50px','50px']" src="img/shape-2.png"></div>
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                        ...
                        <div class="rs-looped rs-slideloop" data-easing="" data-speed="5" data-xe="15" data-xs="-10"
                             data-ye="0" data-ys="0"><img alt="" data-hh="['604px','510','510','510']"
                                                          data-no-retina
                                                          data-ww="['434px','350','350','350']" src="img/vector-art-1.png"></div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row wow fadeInUp">
            <div class="col-md-4">
                <div class="team-item">
                    <!--Team Image-->
                    <img alt="image" class="team-image" src="img/team-img1.png">
                    <!--Name-->
                    <div class="name">
                        <img alt="shape" src="img/shape-10.png">
                        <h6>David Joe</h6>
                    </div>
                    <!--Designation-->
            ...
            <div class="col-md-4">
                <div class="team-item">
                    <!--Team Image-->
                    <img alt="image" class="team-image" src="img/team-img2.png">
                    <!--Name-->
                    <div class="name">
                        <img alt="shape" src="img/shape-9.png">
                        <h6>Natalie Roy</h6>
                    </div>
                    <!--Designation-->
                    <p class="designation mb-2">Director</p>
            ...
            <div class="col-md-4">
                <div class="team-item">
                    <!--Team Image-->
                    <img alt="image" class="team-image" src="img/team-img3.png">
                    <!--Name-->
                    <!--Name-->
                    <div class="name">
                        <img alt="shape" src="img/shape-11.png">
                        <h6>Jhon Wok</h6>
                    </div>
                    <!--Designation-->
                    <p class="designation mb-2">Director</p>
        ...
        <div class="row wow fadeIn">
            <div class="col-md-12">
                ...
                <div class="cbp-l-filters-button" id="js-filters-mosaic-flat">
                    ...
                    <div class="cbp-filter-item" data-filter=".education">Eğitim Yazılımları</div>
                    <span class="text-blue"> / </span>
                    <div class="cbp-filter-item" data-filter=".excavation">Harfiyat Yazılımları</div>
                    <span class="text-blue"> / </span>
                    <div class="cbp-filter-item" data-filter=".restaurant">Restaurant Yazılımları</div>
                    <span class="text-blue"> / </span>
                    <div class="cbp-filter-item" data-filter=".website">Web Siteleri</div>
                </div>

                <!--Portfolio Items-->
                @foreach($products as $product)
                <div id="js-grid-mosaic-flat" class="cbp cbp-l-grid-mosaic-flat">
                    <div class="cbp-item {{$product->categories}}">
                        <a href="product/{{$product->name}}.{{$product->extension}}" class="cbp-caption cbp-lightbox" data-title="See Our Amazing Work">
                            <div class="cbp-caption-defaultWrap">
                                <img src="product/{{$product->name}}.{{$product->extension}}" alt="image" width="380" height="360">
                            </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="cbp-l-caption-alignLeft">
                                    <div class="cbp-l-caption-body">
                                        ...
                                        <p class="text-white">{{$product->header}}</p>
                                    </div>
                                </div>
                            </div>
                        </a>
...
<section class="bg-light" id="blog">
    <div class="container">
        ...
        <div class="row wow fadeInUp">
            ...
            <div class="col-lg-4">
                <div class="news-item">
                    <img alt="image" class="news-img" src="img/blog-news-1.jpg">
                    <div class="news-text-box">
                        ...
                        <a class="author d-flex align-items-center" href="javascript:void(0);">
                            <img alt="image" class="author-img bg-blue" src="img/avatar-1.png">
            ...
            <div class="col-lg-4">
                <div class="news-item">
                    <img alt="image" class="news-img" src="img/blog-news-2.jpg">
                    <div class="news-text-box">
                        <span class="date main-color">October 29, 2020</span>
                        <a href="agency/blog-list.html"><h4 class="news-title">Future of websites</h4></a>
                        <p class="para">Lorem ipsum dolor sit amet consectetur adipiscing elit ipsum dolor sit am...</p>
                        <a class="author d-flex align-items-center" href="javascript:void(0);">
                            <img alt="image" class="author-img bg-purple" src="img/avatar-2.png">
            ...
            <div class="col-lg-4">
                <div class="news-item">
                    <img alt="image" class="news-img" src="img/blog-news-3.jpg">
                    <div class="news-text-box">
                        <span class="date main-color">October 29, 2020</span>
                        <a href="javascript:void(0);"><h4 class="news-title">Digital marketing</h4></a>
                        <p class="para">Lorem ipsum dolor sit amet consectetur adipiscing elit ipsum dolor sit am...</p>
                        <a class="author d-flex align-items-center" href="javascript:void(0);">
                            <img alt="image" class="author-img bg-pink" src="img/avatar-5.png">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="owl-carousel partners-slider">
                    <!--Item-->
                    <div class="logo-item"><img alt="client-logo" src="img/client-1.png"></div>
                    <!--Item-->
                    <div class="logo-item"><img alt="client-logo" src="img/client-2.png"></div>
                    <!--Item-->
                    <div class="logo-item"><img alt="client-logo" src="img/client-3.png"></div>
                    <!--Item-->
                    <div class="logo-item"><img alt="client-logo" src="img/client-4.png"></div>
                </div>
            </div>
        </div>
    </div>
